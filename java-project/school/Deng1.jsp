...
<html>
  <head>
    ...
    <title>My JSP 'Deng1.jsp' starting page</title>
  ...
  <font  size="+12"  color="#7093DB"  face="隶书">
   <marquee align="right" behavior="slive" HSPACE="10PX" SCROLLAMOUNT="40px"  loop="infinite" >武汉轻工大学欢迎您</marquee></font>
    <form name="luogin" onSubmit="return ce(this); " action="Dotext1.jsp" method="post">
    ...
    <td><input  type="text"  size="20" name="number"  value="" style="height:30px ; width:180px;">
    </td>
    </tr>
    <tr>
    <td width="100px" height="50px"align="center">
